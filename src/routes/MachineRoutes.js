...
const MachineRoutes = () => {
    return (
        <Routes>
            ...
            <Route path="power-press-checksheet" element={<DailyPowerPressChecksheet />} /> {/* This is Daily, so no weekly in path */}
            ...
            <Route path="weekly/preventive-vmc" element={<MachinePreventMainForm />} />
            <Route path="weekly/preventive-cnc" element={<CncPreventiveMaintenanceForm />} />
            <Route path="weekly/preventive-powerpress" element={<PowerPressForm />} />
            <Route path="weekly/projection-welding" element={<ProjectionWeldingMaintenanceForm />} />
            <Route path="weekly/vmm" element={<VMMMaintenanceForm />} />
            
            <Route path="weekly/tig" element={<TIGMaintenanceForm />} />
            <Route path="weekly/spot-welding" element={<SpotWeldingMaintenanceForm />} />
            ...
            <Route path="weekly/surface-grinder" element={<SurfaceGrinderMaintenanceForm />} />
            <Route path="weekly/belt-grinder" element={<BeltGrinderMaintenanceForm />} />
            <Route path="weekly/base-grinder" element={<BaseGrinderMaintenanceForm />} />
            
            {/* Dynamic weekly route */}
            <Route path="weekly/preventive-:machineName" element={<MachinePreventMainForm />} />
