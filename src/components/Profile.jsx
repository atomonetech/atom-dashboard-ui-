...
export default function Profile({ onLogout }) {
  ...
  const openCamera = async () => {
    try {
      ...
      alert("Camera not allowed or not available.");
    }
  };
              ...
              >
                ...
                >
                    ...
                    >
                      ...
                      <div
                        ...
                        style={{
                          ...
                          boxShadow:
                            "0 25px 50px -12px rgba(30, 58, 82, 0.5)",
                        }}
                      >
                        <div
                          className={`w-full h-full ${currentAvatar.type === "custom"
                            ? "bg-slate-800"
                  ...
                  <button
                    ...
                    className={`w-full py-3 px-4 rounded-xl font-semibold text-white transition-all flex items-center justify-center gap-2 ${isEditing
