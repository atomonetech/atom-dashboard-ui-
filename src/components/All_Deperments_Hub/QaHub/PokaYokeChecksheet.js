...
//     // 🔥 ADD THIS: Check if this machine already has data for today
...
//     // If you still want to allow override with confirmation, use this instead:
//     /*
//     if (alreadyExistsForThisMachine) {
//         if (!window.confirm(`⚠️ Machine ${selectedMachine} ke liye ${selectedDate} ka data already saved hai.\nPhir bhi save karna hai?`)) {
//             return;
//         }
//     }
//     */
...
//                             <select className="w-full bg-slate-50 border border-gray-300 rounded-lg px-3 py-2 text-sm font-medium focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 outline-none transition disabled:opacity-50 text-slate-700"
//                                 value={selectedMachine} onChange={(e) => setSelectedMachine(e.target.value)} disabled={!selectedPlant}>
