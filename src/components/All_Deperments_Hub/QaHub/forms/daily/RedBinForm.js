...
const RedBinForm = () => {
  ...
  useEffect(() => {
    ...
    // Fetch data in view/review mode
    if (isViewMode) {
      axios
        .get(`${API_BASE_URL}/api/get-single-report/redbin-view/${id}/`)
        .then((res) => {
          if (res.data.success) {
  ...
  }, [id, isViewMode, today, API_BASE_URL, API_DROPDOWN]);
  ...
  const getInputClass = () => {
    const base =
      "w-full border-2 rounded-lg p-2 text-sm outline-none transition-all font-semibold ";

    return isViewMode
      ? base + "bg-slate-100 border-transparent cursor-not-allowed text-slate-600"
      : base +
          "border-slate-100 bg-slate-50 focus:bg-white focus:border-slate-500 text-slate-700";
  };
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-4 mb-4">
                ...
                <div>
                  ...
                  <div className="flex items-center">
                    ...
                    <span
                      className={`px-3 py-2 border-2 border-l-0 rounded-r-lg font-bold text-xs whitespace-nowrap ${
                        isViewMode
              ...
              <div className="mb-4">
                ...
                <textarea
                  ...
                  className={
                    isViewMode
                      ? getInputClass()
                      : "w-full border-2 border-slate-200 rounded-lg p-2 text-sm focus:border-red-400 focus:ring-2 focus:ring-red-100 outline-none text-slate-700 transition-all resize-y"
                  }
                ...
                <div className="mb-4 bg-white border-2 border-red-100 rounded-lg p-3">
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-3">
                    <div>
                      ...
                      <p className="text-lg font-black text-red-600 capitalize">
                        {preparedBy || "—"}
                      </p>
                    </div>
