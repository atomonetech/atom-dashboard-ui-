...
export const dailyReports = [
    { id: 1, title: 'Incoming Material Insp.', formNo: 'AOT/F/QA/01', resp: 'Quality Engineer', icon: 'bi-box-seam', color: '#3b82f6', bg: '#eff6ff', fillRoute: 'Incoming-Material', printKey: 'incomingmaterial-report', viewKey: 'incoming-material-view', isLive: true },
