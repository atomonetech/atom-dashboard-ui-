...
const MachineWeeklyReports = () => {
    ...
    const handleAction = (actionType) => {
        ...
        if (actionType === 'fill') {
            if (machineId.includes('cnc')) navigate("/Weekly-CNC-Form");
            else if (machineId.includes('vmc')) navigate("/Weekly-VMC-Form");
            else if (machineId.includes('power_press') || machineId.includes('powerpress') || machineId.includes('press')) navigate("/Weekly-Power-Press-Form");
            else {
            ...
            if (machineId.includes('cnc')) navigate("/Weekly-CNC-Form/print");
            else if (machineId.includes('vmc')) navigate("/Weekly-VMC-Form/print");
            else if (machineId.includes('power_press') || machineId.includes('powerpress') || machineId.includes('press')) navigate("/Weekly-Power-Press-Form/print");
            else {
                const slug = selectedCard.id.split('_').pop();
