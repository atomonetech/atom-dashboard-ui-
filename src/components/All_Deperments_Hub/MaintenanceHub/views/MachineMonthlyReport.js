    ...
    return (
        <div className="maintenance-page-wrapper">
            ...
            <style>{`
                ...
                .nav-brand-section { font-weight: 800; color: #f59e0b; font-size: 1.2rem; display: flex; align-items: center; gap: 10px; cursor: pointer; }
            ...
            <nav className="hub-main-navbar">
                <div className="nav-brand-section" onClick={() => navigate('/Maintenance/Machine')}>
                    <i className="bi bi-calendar-month-fill"></i> <span>Machine Monthly Reports</span>
                </div>
            </nav>
                        ...
                        <div key={report.id} className="col-12 col-md-6 col-lg-4">
                            <div className="report-card-ui" onClick={() => handleCardClick(report)}>
                                ...
                                <div className="mt-auto">
                                    ...
                                    <div className="meta-pill-ui"><span>Responsibility:</span> <b>{report.responsibility.split('/')[0]}</b></div>
...
//             }
//         } else {
//             // Print routes (Define in MachineRoutes.js)
//             navigate(`${basePath}/${reportId}-print`);
//         }
//         closeModal();
//     };
...
//                             <i className={`bi ${selectedCard.icon}`}></i>
//                         </div>
//                         <h4 className="fw-bold mb-2 text-slate-800">{selectedCard.title}</h4>
//                         <p className="text-muted small mb-4">Choose an action for this report</p>
...
//                         <button className="btn btn-link w-100 mt-2 text-decoration-none text-muted fw-bold" onClick={closeModal}>Discard</button>
//                     </div>
//                 </div>
//             )}
//         </div>
