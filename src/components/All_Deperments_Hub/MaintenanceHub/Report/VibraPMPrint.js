...
const DEFAULT_ITEMS = [
  {
    sr_no: 1,
    check_point: 'Machine Area',
    checking_parameter: 'Clean, no debris',
    checking_method: 'Visual',
  },
  {
    sr_no: 2,
    check_point: 'Mounting Bolts',
    checking_parameter: 'Tight, not loose',
    checking_method: 'Visual/Torque check',
  },
  {
    sr_no: 3,
    check_point: 'Vibrator Motor',
    checking_parameter: 'Normal running sound',
    checking_method: 'Visual/Auditory',
  },
  {
    sr_no: 4,
    check_point: 'Electrical Leads',
    checking_parameter: 'No Damage, secure',
    checking_method: 'Visual',
  },
  {
    sr_no: 5,
    check_point: 'Spring Condition',
    checking_parameter: 'Tight, not loose',
    checking_method: 'Visual',
  },
  {
    sr_no: 6,
    check_point: 'Abnormal Noises',
    checking_parameter: 'Unusual Sounds',
    checking_method: 'Visual/Auditory',
  },
  {
    sr_no: 7,
          ...
          <thead className="table-header-group">
            ...
            <tr className="info-row h-[30px]">
              ...
              <th className={InfoValue}>
                {currentReport?.machine_name || 'Vibra'}
              </th>
...
export default VibraPMCheckSheetPrint;