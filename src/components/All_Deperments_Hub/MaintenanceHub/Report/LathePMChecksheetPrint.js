...
const DEFAULT_ITEMS = [
  {
    ...
    checking_parameter: 'Main motor is working ok?',
    checking_method: 'Visual',
  },
  {
    sr_no: 2,
    check_point: 'Feed Gear & Feed Screw',
    checking_parameter: 'Feed gear & Feed screw are in good condition ?',
    checking_method: 'Visual',
  },
  {
    sr_no: 3,
  ...
  {
    sr_no: 4,
    check_point: 'Cross Slide',
    checking_parameter: 'Cross slide condition good ?',
    checking_method: 'Visual',
  },
  {
    sr_no: 5,
    check_point: 'Tool Post & Position of Thread',
    checking_parameter: 'Tool Post & Position of thread ok ?',
    checking_method: 'Visual',
  },
  {
    sr_no: 6,
    check_point: 'Chuck Jaws',
    checking_parameter: 'Chuck jaws is in good working condition ?',
    checking_method: 'Visual',
  },
  {
    sr_no: 7,
    check_point: 'Oil Level & Oil Seals',
    checking_parameter: 'Oil level & Oil seals are ok ?',
    checking_method: 'Visual',
  },
  {
    sr_no: 8,
    check_point: 'Starter & Wiring',
    checking_parameter: 'Starter & Wiring is in good working condition ?',
    checking_method: 'Visual',
  },
  {
    sr_no: 9,
...
const LatheMachinePMCheckSheetPrint = ({
  items = DEFAULT_ITEMS,
  currentReport,
  onEditForm,
  onBack,
        ...
        <table className="print-table border border-black">
          ...
          <thead className="table-header-group">
            ...
            <tr className="info-row h-[30px]">
              ...
              <th className={InfoValue}>
                {currentReport?.machine_name || 'LATHE MACHINE'}
              </th>
          ...
          <tfoot className="table-footer-group">
            ...
            <tr className="sign-row h-[24px]">
              <td colSpan={3} className="border border-black bg-white text-left align-bottom font-bold footer-text px-1">
                Prepared by
              </td>
...
export default LatheMachinePMCheckSheetPrint;