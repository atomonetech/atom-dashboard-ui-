...
const DEFAULT_ITEMS = [
  ...
  {
    sr_no: 3,
    check_point: 'Slide Oil',
    checking_parameter: 'Slide oil level is ok ?',
    checking_method: 'Visual',
  },
  {
    sr_no: 4,
    check_point: 'Oil Pipes',
    checking_parameter: 'Oil pipes are ok ?',
    checking_method: 'Visual',
  },
  {
    sr_no: 5,
    check_point: 'Lead Screws',
    checking_parameter: 'Damages/Loose/Wornout',
    checking_method: 'Visual/Allen Key',
  },
  {
    sr_no: 6,
    check_point: 'Motor & Spindle Coupling',
    checking_parameter: 'Damages/Loose/Wornout',
    checking_method: 'Visual',
  },
  {
    sr_no: 7,
    check_point: 'Magnetic Base Block',
    checking_parameter: 'Block is magnetised and clean',
    checking_method: 'Visual',
  },
  {
    sr_no: 8,
    check_point: 'Wheel Alignment',
    checking_parameter: 'Alignment ok ?',
    checking_method: 'Visual',
  },
  {
    sr_no: 9,
...
const SurfaceGrinderPMCheckSheetPrint = ({
  items = DEFAULT_ITEMS,
  currentReport,
  onEditForm,
  onBack,
          ...
          <thead className="table-header-group">
            ...
            <tr className="info-row h-[30px]">
              ...
              <th className={InfoValue}>
                {currentReport?.machine_name || 'SURFACE GRINDER'}
              </th>
...
export default SurfaceGrinderPMCheckSheetPrint;