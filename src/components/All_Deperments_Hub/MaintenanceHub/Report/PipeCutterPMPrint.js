...
const DEFAULT_ITEMS = [
  ...
  {
    sr_no: 2,
    check_point: 'Check the on/off condition of power switch button',
    checking_parameter: 'Should be proper working',
    checking_method: 'manual',
  },
  {
    sr_no: 3,
    check_point: 'Check the electrical loose wire and connection',
    checking_parameter: 'Should not be loose and proper working condition',
    checking_method: 'Visual',
  },
  {
    sr_no: 4,
    check_point: 'Check the pedal condition and pedal spring condition',
    checking_parameter: 'Should be proper working condition',
    checking_method: 'Visual',
  },
  {
    sr_no: 5,
    check_point: 'Check blade condition',
    checking_parameter: 'Should be in good condition',
    checking_method: 'Visual',
  },
  {
    sr_no: 6,
    check_point: 'Coolant to be filled',
    checking_parameter: 'Level for coolant should be ok',
    checking_method: 'Visual',
  },
  {
    sr_no: 7,
    check_point: 'Check the oiling and greasing of required moving parts',
    checking_parameter: 'Checking level of oil/grease',
    checking_method: 'By oil gun / grease gun',
  },
  {
    sr_no: 8,
    check_point: 'Check the motor foundation bolt and terminals',
  ...
  {
    sr_no: 10,
    check_point: 'Check the condition of cutting shaft',
    checking_parameter: 'Should be tight',
    checking_method: 'By spanner',
  },
  {
    sr_no: 11,
    check_point: 'Check the condition of level',
    checking_parameter: 'Should be in good condition and working condition',
    checking_method: 'visual',
  },
  {
    sr_no: 12,
...
const PipeCutterPMCheckSheetPrint = ({
  items = DEFAULT_ITEMS,
  currentReport,
  onEditForm,
  onBack,
    ...
    <div className="print-page min-h-screen bg-[#f5f5f5] p-4 text-black flex justify-center print:p-0 print:bg-white overflow-auto print:overflow-visible">
      ...
      <style>{`
        ...
        @media print and (orientation: portrait) {
          ...
          .print-table th,
          .print-table td {
            padding: 0.38mm 0.42mm !important;
          ...
          <thead className="table-header-group">
            ...
            <tr className="info-row h-[30px]">
              ...
              <th className={InfoValue}>
                {currentReport?.machine_name || 'PIPE CUTTER'}
              </th>
...
export default PipeCutterPMCheckSheetPrint;