...
const DEFAULT_ITEMS = [
  ...
  },
  {
    sr_no: 2,
    check_point: 'Head',
    checking_parameter: 'Should be working condition',
    checking_method: 'Visual',
  },
  {
    sr_no: 3,
  ...
  {
    sr_no: 6,
    check_point: 'push button / emergency switch',
  ...
  {
    sr_no: 9,
    check_point: 'Check the preventive maintenance data',
...
const VerticalMillingMachineMaintenancePrint = ({
  items = DEFAULT_ITEMS,
  currentReport,
  onEditForm,
  onBack,
      ...
      >
        <table className="print-table border border-black">
          ...
          <thead className="table-header-group">
            <tr className="doc-row h-[18px]">
              ...
              >
                <img
                  src={atomone}
                  alt="ATOM ONE"
                  className="print-logo max-h-[32px] max-w-full block mx-auto object-contain"
                />
              </th>
              ...
              >
                <h1 className="print-title text-[16px] font-bold uppercase m-0 text-black">
                  VERTICAL MILLING MACHINE MAINTENANCE CHECK SHEET
                </h1>
              </th>
            ...
            <tr className="info-row h-[32px]">
              <th colSpan={2} className={InfoLabel}>
                MACHINE NAME:
              </th>

              <th className={InfoValue}>
                {currentReport?.machine_name || 'VMM'}
              </th>
            ...
            <tr className="column-header-row h-[48px]">
          ...
          <tfoot className="table-footer-group">
            <tr className="blank-row h-[36px]">
              <td colSpan={7} className="border border-black bg-white"></td>
            </tr>

            <tr className="legend-row h-[18px]">
              <td colSpan={2} rowSpan={4} className="border border-black bg-white"></td>

              <td colSpan={2} className="border border-black bg-white text-center font-bold footer-text text-[9px]">
                Legends
              </td>
...
export default VerticalMillingMachineMaintenancePrint;