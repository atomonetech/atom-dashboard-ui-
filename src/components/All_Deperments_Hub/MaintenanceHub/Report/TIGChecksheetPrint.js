...
const DEFAULT_ITEMS = [
  ...
  {
    sr_no: 3,
    check_point: 'Check the electric loose wires & connections',
    checking_parameter: 'Should not be loose and proper connected',
    checking_method: 'Visual',
  },
  {
    sr_no: 4,
    check_point: 'Check the current indicator and current setting knob',
    checking_parameter: 'Should be Proper working',
    checking_method: 'Visual',
  },
  {
    sr_no: 5,
    check_point: 'Check the earthing of welding machine',
    checking_parameter: 'Should be proper earthing',
    checking_method: 'Manual',
  },
  {
    sr_no: 6,
    check_point: 'Check the working of welding torch/gun',
    checking_parameter: 'Should be Proper working',
    checking_method: 'Manual',
  },
  {
    sr_no: 7,
    check_point: 'Check the condition of nozzle, collet, nozzle cap, etc',
    checking_parameter: 'Should be in good/usable condition',
    checking_method: 'Manual',
  },
  {
    sr_no: 8,
    check_point: 'Check the working of gas flow meter',
    checking_parameter: 'Should be Proper working',
    checking_method: 'Visual',
  },
  {
    sr_no: 9,
    check_point: 'Check the regulator of gas cylinder',
    checking_parameter: 'Should be Proper working',
    checking_method: 'Visual/Manual',
  },
  {
    sr_no: 10,
    check_point: 'Check the working of pressure gage',
    checking_parameter: 'Should be Proper working',
    checking_method: 'Visual',
  },
  {
    sr_no: 11,
    check_point: 'Check the leakage of Argon gas hose pipe',
    checking_parameter: 'Should be tight and no leakage',
    checking_method: 'By plier / spanner',
  },
  {
    sr_no: 12,
...
const TigWeldingMachinePreventiveMaintenanceCheckSheetPrint = ({
  items = DEFAULT_ITEMS,
  currentReport,
  onEditForm,
  onBack,
          ...
          <thead className="table-header-group">
            ...
            <tr className="info-row h-[30px]">
              ...
              <th className={InfoValue}>
                {currentReport?.machine_name || 'TIG WILDING M/C'}
              </th>
...
export default TigWeldingMachinePreventiveMaintenanceCheckSheetPrint;