...
const DEFAULT_ITEMS = [
  {
    sr_no: 1,
    check_point: 'Air Filter',
    checking_parameter: 'Clean air filter',
    checking_method: 'visual',
  },
  {
    sr_no: 2,
    check_point: 'Digital pannel',
    checking_parameter: 'Digital pannel is working',
    checking_method: 'visual',
  },
  {
    sr_no: 3,
    check_point: 'Air pressure',
    checking_parameter: 'Check air pressure',
    checking_method: 'visual',
  },
  {
    sr_no: 4,
    check_point: 'Electrode alignment',
    checking_parameter: 'Check alignment of electrode',
    checking_method: 'visual',
  },
  {
    sr_no: 5,
    check_point: 'Abnormal sound',
    checking_parameter: 'Any abnormal sound heard ?',
    checking_method: 'Hearing',
  },
  {
    sr_no: 6,
    check_point: 'Starter & wiring',
    checking_parameter: 'Starter & wiring is in good condition',
    checking_method: 'visual',
  },
  {
    sr_no: 7,
    check_point: 'Push button',
...
const ProjectionWeldingMaintenancePrint = ({
  items = DEFAULT_ITEMS,
  currentReport,
  onEditForm,
  onBack,
    ...
    <div className="print-page min-h-screen bg-[#f5f5f5] p-4 text-black flex justify-center print:p-0 print:bg-white overflow-auto print:overflow-visible">
      ...
      <style>{`
        ...
        @media print and (orientation: portrait) {
          ...
          .print-table th,
          .print-table td {
            padding: 0.5mm 0.45mm !important;
          ...
          <thead className="table-header-group">
            ...
            <tr className="info-row h-[32px]">
              ...
              <th className={InfoValue}>
                {currentReport?.machine_name || 'PROJECTION WELDING'}
              </th>
...
export default ProjectionWeldingMaintenancePrint;