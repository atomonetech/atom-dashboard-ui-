...
const DEFAULT_ITEMS = [
  { sr_no: 1, check_point: 'Lub oil pressure (12 to 15 bar)', checking_method: 'Visual' },
  { sr_no: 2, check_point: 'Lub oil level', checking_method: 'Visual' },
  { sr_no: 3, check_point: 'Hydraulic oil level and condition', checking_method: 'Visual' },
  { sr_no: 4, check_point: 'Hydraulic system pressure', checking_method: 'Visual' },
  { sr_no: 5, check_point: 'Chuck clamping Pressure', checking_method: 'Visual' },
  { sr_no: 6, check_point: 'Coolant level in coolant tank', checking_method: 'Visual' },
  { sr_no: 7, check_point: 'work holding greasing', checking_method: 'Visual' },
  { sr_no: 8, check_point: 'Oil level in chip conveyor gear', checking_method: 'Visual' },
  { sr_no: 9, check_point: 'Oil/coolant leakage in fitting', checking_method: 'Visual' },
  { sr_no: 10, check_point: 'Lubricator hose condition', checking_method: 'Visual' },
  { sr_no: 11, check_point: 'Spindle belt condition, belt tension', checking_method: 'Feel by Hand' },
  { sr_no: 12, check_point: 'Spindle motor blower fan', checking_method: 'Visual' },
  { sr_no: 13, check_point: 'Drive cooling fan', checking_method: 'Visual' },
  { sr_no: 14, check_point: 'Overall cleaning', checking_method: 'By clothes / brushes' },
];
    ...
    <div className="print-page min-h-screen bg-[#f5f5f5] p-4 text-black flex justify-center print:p-0 print:bg-white overflow-auto print:overflow-visible">
      ...
      <style>{`
        ...
        @media print and (orientation: portrait) {
          ...
          .print-table th,
          .print-table td {
            padding: 0.4mm 0.45mm !important;
        ...
        @media print and (orientation: landscape) {
          ...
          .print-table th,
          .print-table td {
            padding: 0.32mm 0.45mm !important;
          ...
          <thead className="table-header-group">
            ...
            <tr className="info-row h-[30px]">
              ...
              <th className={InfoValue}>
                {currentReport?.machine_name || 'CNC MACHINE'}
              </th>
            ...
            <tr className="info-row h-[30px]">
              ...
              <th className={InfoLabel}>LOCATION</th>
            ...
            <tr className="spec-row h-[40px]">
              ...
              <th className={InfoLabel}>MAINTENANCE <br /> PERSONNEL</th>
...
export default CNCMaintenancePrint;