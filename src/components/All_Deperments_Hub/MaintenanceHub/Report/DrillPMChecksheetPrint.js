...
const DEFAULT_ITEMS = [
  ...
  {
    sr_no: 2,
    check_point: 'Spindle Bearing',
    checking_parameter: 'Spindle bearing is in good condition ?',
    checking_method: 'Visual',
  },
  {
    sr_no: 3,
    check_point: 'Main Spindle',
    checking_parameter: 'Main spindle is in good condition ?',
    checking_method: 'Visual',
  },
  {
    sr_no: 4,
  ...
  {
    sr_no: 5,
    check_point: 'Drill Chuck',
    checking_parameter: 'Drill chuck is in good condition ?',
    checking_method: 'Visual',
  },
  {
    sr_no: 6,
    check_point: 'Shaft Alignment',
    checking_parameter: 'Shaft alignment is ok ?',
    checking_method: 'Visual',
  },
  {
    sr_no: 7,
...
const DrillMachinePMCheckSheetPrint = ({
  items = DEFAULT_ITEMS,
  currentReport,
  onEditForm,
  onBack,
          ...
          <thead className="table-header-group">
            ...
            <tr className="info-row h-[30px]">
              ...
              <th className={InfoValue}>
                {currentReport?.machine_name || 'VERTICAL DRILL MACHINE'}
              </th>
...
export default DrillMachinePMCheckSheetPrint;