...
const DEFAULT_ITEMS = [
  ...
  {
    sr_no: 2,
    check_point: 'CHECK THE DOL STARTER PROPER WORKING',
    checking_parameter: 'PROPER WORKING',
    checking_method: 'MANUAL',
  },
  {
    sr_no: 3,
    check_point: 'CHECK OIL LEAKAGE',
    checking_parameter: 'NO LEAKAGE',
    checking_method: 'BY SPANNER',
  },
  {
    sr_no: 4,
    check_point: 'CHECK HYDRAULIC HOSE PIPE CONDITION',
    checking_parameter: 'NO DAMAGE / LEAKAGE',
    checking_method: 'VISUAL',
  },
  {
    sr_no: 5,
    check_point: 'CHECK SOLENOID VALVE WORKING CONDITION',
    checking_parameter: 'PROPER WORKING',
    checking_method: 'MANUAL',
  },
  {
    sr_no: 6,
    check_point: 'CHECK THE OIL TANK CONDITION',
    checking_parameter: 'NO CONTAMINATION IT SHOULD BE CLEAN',
    checking_method: 'BY DIESEL / WASTE COTTON',
  },
  {
    sr_no: 7,
    check_point: 'CHECK THE CONNECTION OF SOLENOID VALVE COIL',
    checking_parameter: 'SHOULD BE PROPER TIGHT',
    checking_method: 'MANUAL',
  },
];
...
const HydraulicMachinePreventiveMaintenanceCheckSheetPrint = ({
  items = DEFAULT_ITEMS,
  currentReport,
  onEditForm,
  onBack,
    ...
    <div className="print-page min-h-screen bg-[#f5f5f5] p-4 text-black flex justify-center print:p-0 print:bg-white overflow-auto print:overflow-visible">
      ...
      <style>{`
        ...
        @media print and (orientation: portrait) {
          ...
          .print-table th,
          .print-table td {
            padding: 0.55mm 0.5mm !important;
          ...
          <thead className="table-header-group">
            ...
            <tr className="info-row h-[30px]">
              ...
              <th className={InfoValue}>
                {currentReport?.machine_name || 'HYDRAULIC M/C'}
              </th>
...
export default HydraulicMachinePreventiveMaintenanceCheckSheetPrint;