...
const DEFAULT_ITEMS = [
  ...
  },
  {
    ...
    checking_parameter: 'Should be proper',
    checking_method: 'By spanner',
  },
  {
    sr_no: 3,
    check_point: 'Check the air filter',
    checking_parameter: 'Should be proper condition',
    checking_method: 'By spanner',
  },
  {
    sr_no: 4,
    check_point: 'Check the air receiver',
    checking_parameter: 'Should be cleaned',
    checking_method: 'Visual',
  },
  {
    sr_no: 5,
    check_point: 'Check any abnormal sound',
    checking_parameter: 'No abnormal sound',
    checking_method: 'Visual',
  },
  {
    sr_no: 6,
    check_point: 'Check nut & bolt',
    checking_parameter: 'Should be tight',
    checking_method: 'By Spanner / allen key',
  },
  {
    sr_no: 7,
    check_point: 'Check loose wiring',
    checking_parameter: 'Should be tight',
...
const CompressorPreventiveMaintenanceCheckSheetPrint = ({
  items = DEFAULT_ITEMS,
  currentReport,
  onEditForm,
  onBack,
          ...
          <thead className="table-header-group">
            ...
            <tr className="info-row h-[30px]">
              ...
              <th className={InfoValue}>
                {currentReport?.machine_name || 'COMPRESSOR'}
              </th>
...
export default CompressorPreventiveMaintenanceCheckSheetPrint;