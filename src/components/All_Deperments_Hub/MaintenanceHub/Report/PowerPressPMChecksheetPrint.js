...
const DEFAULT_ITEMS = [
  {
    sr_no: 1,
    check_point: 'Clean the machine by cloth',
    checking_parameter: 'Dust free',
    checking_method: 'Visual',
  },
  {
    sr_no: 2,
    check_point: 'Check the v-belt condition/looseness',
    checking_parameter: 'Should be correct or replace',
    checking_method: 'By hand',
  },
  {
    sr_no: 3,
    check_point: 'Check the diecushion bolt & working function, if applicable',
    checking_parameter: 'Should be tight & proper up down',
    checking_method: 'By Spanner / allen key',
  },
  {
    sr_no: 4,
    check_point: 'Check the motor foundation bolt & terminals',
    checking_parameter: 'Should be tight',
    checking_method: 'By Spanner / plier',
  },
  {
    sr_no: 5,
    check_point: 'Check the slide guide plate bolt',
    checking_parameter: 'Should be tight',
    checking_method: 'By Spanner / allen key',
  },
  {
    sr_no: 6,
    check_point: 'Check the loose wiring',
    checking_parameter: 'Proper dressing',
    checking_method: 'By hand / plier / screw driver',
  },
  {
    sr_no: 7,
    check_point: 'Checking of all push button, emergency switch',
    checking_parameter: 'Should be proper working',
    checking_method: 'By hand operation',
  },
  {
    sr_no: 8,
    check_point: 'Check the Oiling & greasing of required moving parts',
    checking_parameter: 'Should be oil / grease',
    checking_method: 'By oil cane / grease gun',
  },
  {
    sr_no: 9,
    check_point: 'Check the parallelism between lower and upper bed every 6 months',
    checking_parameter: 'LxR=0.50(MAX), FxB=0.94(MAX)',
    checking_method: 'By dial gauge',
  },
  {
    sr_no: 10,
    check_point: 'Check the crank upper & bottom plate bolt',
    checking_parameter: 'Should be tight',
    checking_method: 'By Spanner / allen key',
  },
  {
    sr_no: 11,
    check_point: 'Check the looseness any bolts',
    checking_parameter: 'Should be tight',
    checking_method: 'By spanner',
  },
  {
    sr_no: 12,
    check_point: 'Check the Brake Liner condition',
    checking_parameter: 'Should be in Good Condition',
    checking_method: 'Visual',
  },
  {
    sr_no: 13,
    check_point: 'Check the T-slot condition',
    checking_parameter: 'Should be clean',
    checking_method: 'Visual',
  },
  {
    sr_no: 14,
    check_point: 'Check the Rolling & L-Key,s',
    checking_parameter: 'Should be in Good working Condition',
    checking_method: 'Visual',
  },
  {
    sr_no: 15,
...
const PowerPressPreventiveMaintenanceCheckSheetPrint = ({
  items = DEFAULT_ITEMS,
  currentReport,
  onEditForm,
  onBack,
        ...
        <table className="print-table border border-black">
          ...
          <thead className="table-header-group">
            ...
            <tr className="info-row h-[30px]">
              <th colSpan={2} className={InfoLabel}>MACHINE NAME:</th>

              <th className={InfoValue}>
                {currentReport?.machine_name || 'POWER PRESS'}
              </th>
            ...
            <tr className="info-row h-[30px]">
              <th colSpan={2} className={InfoLabel}>MACHINE NO.:</th>

              <th className={InfoValue}>
                {currentReport?.machine_no || ''}
              </th>

              <th colSpan={2} className={InfoLabel}>LOCATION</th>
            ...
            <tr className="spec-row h-[40px]">
              <th colSpan={2} className={InfoLabel}>SPECIFICATION</th>

              <th className={`${InfoValue} text-cell`}>
                {currentReport?.specification || ''}
              </th>

              <th colSpan={2} className={InfoLabel}>MAINTENANCE PERSONNEL</th>
            ...
            <tr className="column-header-row h-[45px]">
              ...
              <th className={TH}>Spare / Remarks</th>
            </tr>
          </thead>
...
export default PowerPressPreventiveMaintenanceCheckSheetPrint;