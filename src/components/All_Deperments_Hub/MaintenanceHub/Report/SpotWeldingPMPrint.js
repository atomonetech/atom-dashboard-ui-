...
const DEFAULT_ITEMS = [
  ...
  {
    sr_no: 2,
    check_point: 'Coolant Pump',
    checking_parameter: 'Coolant pump is working',
    checking_method: 'Visual',
  },
  {
    sr_no: 3,
    check_point: 'Digital Panel',
    checking_parameter: 'Digital panel is working',
    checking_method: 'Visual',
  },
  {
    sr_no: 4,
  ...
  },
  {
    ...
    checking_parameter: 'Check alignment of electrodes',
    checking_method: 'Visual',
  },
  {
    sr_no: 6,
...
const SpotWeldingMachinePreventiveMaintenanceCheckSheetPrint = ({
  items = DEFAULT_ITEMS,
  currentReport,
  onEditForm,
  onBack,
          ...
          <thead className="table-header-group">
            ...
            <tr className="info-row h-[30px]">
              ...
              <th className={InfoValue}>
                {currentReport?.machine_name || 'SPOT WELDING M/C'}
              </th>
...
export default SpotWeldingMachinePreventiveMaintenanceCheckSheetPrint;