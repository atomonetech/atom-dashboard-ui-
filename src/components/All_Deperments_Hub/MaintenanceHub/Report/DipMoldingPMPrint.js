...
const DEFAULT_ITEMS = [
  {
    ...
    checking_parameter: 'Check all push button',
    checking_method: 'Manually',
  },
  {
    sr_no: 2,
    check_point: 'Proximity Sensor',
    checking_parameter: 'Check Working condition',
    checking_method: 'Manually',
  },
  {
    sr_no: 3,
    check_point: 'Limit Switch',
    checking_parameter: 'Check all Limit Switchs',
    checking_method: 'Manually',
  },
  {
    sr_no: 4,
    check_point: 'Servo Motor',
    checking_parameter: 'Check Working condition',
    checking_method: 'Visually',
  },
  {
    sr_no: 5,
    check_point: 'Counter Balance Cylinder',
    checking_parameter: 'Air Leakages',
    checking_method: 'Visually',
  },
  {
    sr_no: 6,
    check_point: 'Timer Display',
    checking_parameter: 'Timer Working Condition',
    checking_method: 'Visually',
  },
  {
    sr_no: 7,
    check_point: 'Control Panel Box',
    checking_parameter: 'Loose wiring',
    checking_method: 'Visually',
  },
  {
    sr_no: 8,
    check_point: 'Roller Bearing',
    checking_parameter: 'Bearing Running condition',
    checking_method: 'Manually',
  },
  {
    sr_no: 9,
...
const DipMoldingPMCheckSheetPrint = ({
  items = DEFAULT_ITEMS,
  currentReport,
  onEditForm,
  onBack,
          ...
          <thead className="table-header-group">
            ...
            <tr className="info-row h-[30px]">
              ...
              <th className={InfoValue}>
                {currentReport?.machine_name || 'Dip Molding'}
              </th>
...
export default DipMoldingPMCheckSheetPrint;