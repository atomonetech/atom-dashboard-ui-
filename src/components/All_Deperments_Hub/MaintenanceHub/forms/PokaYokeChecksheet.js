                 ...
                 const currentUser = localStorage.getItem("username") || "Unknown User";
                        ...
                        try {
                          await axios.post(API_LOG, {
                            ...
                            report_name: "poka yoka machine Form", // Yahan hardcode kar diya form ka naam
                          });
            ...
            <nav className="fixed top-0 left-0 right-0 bg-white border-b border-gray-200 z-[10000] shadow-sm">
                <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between h-14 sm:h-16">
                        ...
                        <div onClick={() => navigate('/Maintenance/Machine/daily')} className="flex items-center gap-2 cursor-pointer group min-w-0 flex-1">
