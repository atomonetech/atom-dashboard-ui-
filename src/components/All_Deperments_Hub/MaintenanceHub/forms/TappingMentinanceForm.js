...
const TappingMaintenanceForm = () => {
 ...
 const initialChecklist = [
  ...
  const initialMetaData = {
    machineName: location.state?.machineName || "Pipe Cutter",
      ...
      >
        ...
        >
          <h3
            ...
            style={{ color: "#10b981" }}
          >
            Pipe Cutting Preventive Maintenance
          </h3>
...
export default TappingMaintenanceForm;