    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                alert("Failed to save plan data: " + JSON.stringify(errorData));
            }
        } catch (error) {
                    ...
                    <form onSubmit={handleSubmit} className="p-6 md:p-10 space-y-8">
                        ...
                        <div className="flex justify-center md:justify-end pt-4">
                            <button
                                ...
                                className={`px-12 py-4 rounded-xl font-black text-white text-[11px] tracking-[0.2em] transition-all shadow-xl active:scale-[0.95] ${isSubmitting
                                        ? 'bg-slate-300'
