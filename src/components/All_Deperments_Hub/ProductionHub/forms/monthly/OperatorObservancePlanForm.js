    ...
    return (
        <div className="min-h-screen bg-[#f8fafc] font-sans text-slate-900 pb-10 flex flex-col items-center">
            ...
            <div className="w-full max-w-5xl px-4 mt-6">
                ...
                <div className="w-full bg-gradient-to-br from-[#6366f1] via-[#4f46e5] to-[#3730a3] rounded-t-[2rem] p-8 md:p-12 text-center shadow-xl border-b border-white/10">
                    ...
                    <p className="text-indigo-100 text-[10px] md:text-xs font-bold mt-2 tracking-[0.3em] uppercase opacity-80">
