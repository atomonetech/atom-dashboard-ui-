      ...
      <div className="bg-white rounded-sm shadow-sm border border-gray-100 p-4 sm:p-5 md:p-6">
        ...
        <form onSubmit={handleSubmit}>
         ...
         <div className="mt-8 pt-6 border-t border-gray-100 flex flex-col gap-4">
            ...
            {/* Dynamic Footprints Container */}
            <div className="w-full">
              {id ? (
                /* 1. REVIEW MODE: Side-by-side structural layout aligning elements perfectly to the bottom baseline */
                <div className="flex flex-col lg:flex-row items-stretch lg:items-end gap-6 w-full">
                  
                  {/* Textarea grows to occupy all available left space context */}
                  <div className="flex flex-col gap-1.5 flex-1 w-full">
                    ...
                    <textarea
                      ...
                      className="w-full border border-gray-300 rounded-xl p-3.5 text-sm text-black bg-white placeholder-gray-400 focus:outline-none focus:ring-4 focus:ring-purple-100 focus:border-[#916cf6] transition-all font-sans shadow-sm min-h-[96px] max-h-[220px]"
                    />
                  </div>

                  {/* High-Vibrancy Review Buttons group level with baseline metrics */}
                     {!isReadOnly && (
                ...
                /* 2. OPERATOR MODE: Standard entry layout layout pipeline */
                <div className="flex flex-col gap-4 w-full">
                  {/* Standard non-review layout tracking textarea */}
                  {id && (
                  ...
                  {/* Standard Action button elements block */}
                  <div className="flex flex-col sm:flex-row gap-3 justify-end items-center w-full">
                    <button
                      type="button"
                      onClick={handleReset}
                      disabled={isLoading}
                      className="w-full sm:w-auto px-6 py-3 border-2 border-gray-300 hover:bg-gray-50 text-gray-700 font-bold tracking-wide rounded-none transition-all text-sm disabled:opacity-50 uppercase"
                    >
                      RESET FORM
                    </button>
                    ...
                    <button
                      type="submit"
                      disabled={isLoading}
                      className="w-full sm:w-auto px-8 py-3 bg-[#916cf6] hover:bg-[#7b55e0] shadow-md text-white font-bold tracking-wide rounded-none transition-all text-sm flex items-center justify-center gap-2 disabled:opacity-70 uppercase"
                    >
                      {isLoading && (
                        <Loader2 size={16} className="animate-spin" />
                      )}
