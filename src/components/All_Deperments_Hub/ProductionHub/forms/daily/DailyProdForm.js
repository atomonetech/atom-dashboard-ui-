...
const DailyProdForm = () => {
  ...
  const handleChange = (e) => {
    ...
    // ✅ AUTO CALCULATE TOTAL WORKING TIME
      ...
      const start =
        name === "productionStartTime" ? value : formData.productionStartTime;
      const end =
        name === "productionEndTime" ? value : formData.productionEndTime;
  ...
  const handleSubmit = async (e) => {
    ...
    const payload = {
      ...
      achieved_quantity: formData.achievedQuantity
        ? parseInt(formData.achievedQuantity)
        : 0,
      qty_remark: formData.qtyRemark,
      production_start_time: formData.productionStartTime
        ? formData.productionStartTime
        : null,
      ...
      tool_setup_time: formData.toolSetupTime
        ? parseInt(formData.toolSetupTime)
        : 0,
      machine_bd_time: formData.machineBdTime
        ? parseInt(formData.machineBdTime)
        : 0,
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
              ...
              <div className="flex flex-col">
                <label className="block text-xs font-semibold text-slate-700 mb-1 uppercase tracking-wide">
                  <Factory size={14} className="inline mr-1 text-blue-500" />{" "}
              ...
              <div className="flex flex-col">
                <label className="block text-xs font-semibold text-slate-700 mb-1 uppercase tracking-wide">
                  <ListFilter size={14} className="inline mr-1 text-blue-500" />{" "}
              ...
              <div className="flex flex-col">
                ...
                <select
                  ...
                  onChange={handleChange}
                  disabled={!formData.plant || machinesLoading}
              ...
              <div className="flex flex-col">
                <label className="block text-xs font-semibold text-slate-700 mb-1 uppercase tracking-wide">
                  <Hash size={14} className="inline mr-1 text-blue-500" /> Part
                ...
                <input
                  ...
                  className="w-full px-3 py-2 text-sm bg-slate-100 border border-slate-300 rounded-lg text-slate-500 cursor-not-allowed focus:outline-none"
                />
              </div>
              ...
              <div className="flex flex-col">
                <label className="block text-xs font-semibold text-slate-700 mb-1 uppercase tracking-wide">
                  ...
                  {formData.totalWorkingTime && (
                    <span className="ml-1 text-green-500 text-xs normal-case font-normal">
                      (auto)
                    </span>
                  )}
                </label>
              ...
              <div className="flex flex-col">
                <label className="block text-xs font-semibold text-slate-700 mb-1 uppercase tracking-wide">
                  <Layers size={14} className="inline mr-1 text-indigo-500" />{" "}
                  RM Coil / Lot No.
                </label>
                <input
                  type="text"
                  ...
                  onChange={handleChange}
                  placeholder="Enter lot or coil number"
                  className="w-full px-3 py-2 text-sm bg-white border border-slate-300 rounded-lg focus:outline-none focus:border-[#3b82f5] focus:ring-1 focus:ring-[#3b82f5] text-slate-700 placeholder-slate-400"
                />
              </div>
