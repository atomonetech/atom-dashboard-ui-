...
// // ORIGINAL PREMIUM DESIGN + EXACT DATA MAPPING
...
// src/components/Plant2Live.js
// ORIGINAL PREMIUM DARK DESIGN + EXACT DATA MAPPING
...
export default function Plant2Live() {
  ...
  return (
    <div style={{
      minHeight: '100vh',
      background: 'radial-gradient(circle at top, #1e293b 0%, #020617 100%)', // The Premium Dark Background
      padding: '20px',
      color: '#f8fafc',
      fontFamily: "'Inter', 'Segoe UI', sans-serif"
    }}>
